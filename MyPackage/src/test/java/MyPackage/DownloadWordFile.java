...
/*		// chrome
		...
		ChromeOptions options = new ChromeOptions();                        // passing preferences in chrome options
...
/*		// edge browser
		...
		profile.setPreference("browser.helperApps.neverAsk.saveToDisk", "application/msword"); // we have to specify mime type of file we want to download
